...
class PDFJS {
  ...
  static bool? get cMapPacked =>
      versionSafePdfJsContext?['cMapPacked'] as bool?;
  ...
  static int? get maxImageSize =>
      versionSafePdfJsContext?['maxImageSize'] as int?;
  ...
  static String? get workerSrc =>
      versionSafePdfJsContext?['workerSrc'] as String?;
